...
const wipItems = [
  {
    id: 1,
    name: "devpilot-ai",
    description: "Full-stack SaaS for developers - AI-powered code reviews, documentation, bug detection, and test generation using LLMs",
    progress: 60,
  ...
  },
  {
    ...
    description: "Real-time weapon detection system using YOLO for surveillance with custom dataset training",
    progress: 100,
  ...
  {
    id: 3,
    name: "coal-mine-safety",
    description: "App & web-based software for productivity and safety management in coal mines",
    progress: 100,
...
const recentActivity = [
  { type: "commit", project: "devpilot-ai", message: "Implement LLM-powered code review API", time: "2 hours ago" },
  { type: "commit", project: "devpilot-ai", message: "Add test case generation module", time: "1 day ago" },
  { type: "commit", project: "devpilot-ai", message: "Setup authentication and user dashboard", time: "3 days ago" },
  { type: "branch", project: "devpilot-ai", message: "Created feature/documentation branch", time: "5 days ago" },
]
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-b border-border/50 bg-secondary/40 px-4 sm:px-5 py-3.5 sm:py-4">
                ...
                <span className="ml-4 font-mono text-xs text-muted-foreground truncate">~/nihar0123/active</span>
