...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/nihar0123", handle: "@nihar0123", icon: Github },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/nihar-bhatt-22762b256", handle: "/in/nihar-bhatt", icon: Linkedin },
  { label: "Email", href: "mailto:niharbhatt000@gmail.com", handle: "niharbhatt000@gmail.com", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} NB — AI/ML Engineer
          </p>
        </div>
      </div>
    </footer>
