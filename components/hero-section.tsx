...
const roles = ["building AI models", "exploring ML systems", "crafting neural networks", "training algorithms", "deploying intelligence"]
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Computer Engineering undergraduate at MIT Academy of Engineering with hands-on experience in Machine Learning and Computer Vision. 
              Built real-time object detection systems using YOLO and developed data-driven automation tools.
              Currently <span className="text-foreground font-medium">open to opportunities</span>.
            </p>
